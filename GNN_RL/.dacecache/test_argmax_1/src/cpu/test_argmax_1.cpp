...
void __program_test_argmax_1_internal(double * __restrict__ A, int * __restrict__ __return)
{
...
DACE_EXPORTED void __program_test_argmax_1(double * __restrict__ A, int * __restrict__ __return)
{
    __program_test_argmax_1_internal(A, __return);
}

DACE_EXPORTED int __dace_init_test_argmax_1(double * __restrict__ A, int * __restrict__ __return)
{
    int __result = 0;
...
DACE_EXPORTED void __dace_exit_test_argmax_1(double * __restrict__ A, int * __restrict__ __return)
{
}
