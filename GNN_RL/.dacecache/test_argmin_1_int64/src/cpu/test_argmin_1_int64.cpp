...
void __program_test_argmin_1_int64_internal(long long * __restrict__ A, int * __restrict__ __return)
{
                ...
                for (auto __i2 = 0; __i2 < 3; __i2 += 1) {
                    {
                        ...
                        __init = _val_and_idx { .idx = (- 1), .val = 9223372036854775807 };
                        ///////////////////
...
DACE_EXPORTED void __program_test_argmin_1_int64(long long * __restrict__ A, int * __restrict__ __return)
{
    __program_test_argmin_1_int64_internal(A, __return);
}

DACE_EXPORTED int __dace_init_test_argmin_1_int64(long long * __restrict__ A, int * __restrict__ __return)
{
    int __result = 0;
...
DACE_EXPORTED void __dace_exit_test_argmin_1_int64(long long * __restrict__ A, int * __restrict__ __return)
{
}
