...
void __program_test_argmin_result_internal(double * __restrict__ A, int * __restrict__ __return)
{
        ...
        
        {
            ...
            for (auto __i0 = 0; __i0 < 10; __i0 += 1) {
                for (auto __i1 = 0; __i1 < 5; __i1 += 1) {
                    for (auto __i2 = 0; __i2 < 3; __i2 += 1) {
                        {
                            double __in = A[(((15 * __i0) + (3 * __i1)) + __i2)];
                            _val_and_idx __out;
...
DACE_EXPORTED void __program_test_argmin_result(double * __restrict__ A, int * __restrict__ __return)
{
    __program_test_argmin_result_internal(A, __return);
}

DACE_EXPORTED int __dace_init_test_argmin_result(double * __restrict__ A, int * __restrict__ __return)
{
    int __result = 0;
...
DACE_EXPORTED void __dace_exit_test_argmin_result(double * __restrict__ A, int * __restrict__ __return)
{
}
