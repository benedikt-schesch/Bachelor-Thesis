...
void __program_test_argmax_1_int32_internal(int * __restrict__ A, int * __restrict__ __return)
{
                ...
                for (auto __i2 = 0; __i2 < 3; __i2 += 1) {
                    {
                        ...
                        __init = _val_and_idx { .idx = (- 1), .val = (- 2147483648) };
                        ///////////////////
...
DACE_EXPORTED void __program_test_argmax_1_int32(int * __restrict__ A, int * __restrict__ __return)
{
    __program_test_argmax_1_int32_internal(A, __return);
}

DACE_EXPORTED int __dace_init_test_argmax_1_int32(int * __restrict__ A, int * __restrict__ __return)
{
    int __result = 0;
...
DACE_EXPORTED void __dace_exit_test_argmax_1_int32(int * __restrict__ A, int * __restrict__ __return)
{
}
