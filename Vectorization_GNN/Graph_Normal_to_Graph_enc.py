...
with open("/Users/benediktschesch/MyEnv/Vectorization_GNN/temp/Vect_graphs_normalized.pkl", "rb") as fp:    
...
with open("/Users/benediktschesch/MyEnv/Vectorization_GNN/temp/Vect_graphs_data.pkl", "wb") as fp:
