...
with open("/Users/benediktschesch/MyEnv/Vectorization_GNN/temp/Vect_graphs_raw.pkl", "rb") as fp:    
...
with open("/Users/benediktschesch/MyEnv/Vectorization_GNN/temp/Vect_graphs_normalized.pkl", "wb") as fp:
